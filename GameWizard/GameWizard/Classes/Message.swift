    ...
    func path(in rect: CGRect)-> Path{
        Path{ path in
           ...
           let y0 = rect.origin.y
            ...
            path.addLine(to: CGPoint(x: w, y: y0+h*0.05))
            ...
            path.addLine(to: CGPoint(x: w , y: h - h*0.05))
